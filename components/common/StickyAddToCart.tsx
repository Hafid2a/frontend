      ...
      {visible && (
        ...
        >
          <div className="mx-auto max-w-3xl">
            <button
              onClick={handleAdd}
              className="flex w-full items-center justify-center gap-3 rounded-[18px] bg-najd-green px-6 py-4 text-base font-medium text-white shadow-[0_12px_35px_rgba(194,70,111,0.4)] transition-colors hover:bg-najd-green/90"
            >
