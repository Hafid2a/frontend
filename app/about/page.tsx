      ...
      <section className="py-20 text-center max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <h1 className="text-stone font-bold text-4xl md:text-5xl mb-4">
            نجد علامة سعودية لوجه تحت الإيشارب والجو المحلي.
          </h1>
          <p className="text-muted text-lg leading-relaxed max-w-2xl mx-auto">
            بدأنا من ملاحظة بسيطة: كثير من البنات يحتاجن مستحضرات وجه بوصف واضح
            للثبات والحماية النهارية ولخط الجبهة مع الإيشارب — عبوّة مهيّأة
            وتجربة تفهم الدوام والمناسبات والحرّ، بدون خلط بين المنتج الموضَّع
            ووعود طبّية كبيرة على شاشة واحدة.
          </p>
        </motion.div>
      </section>
          ...
          <motion.div {...fadeUp}>
            ...
            <div className="space-y-4 text-muted leading-relaxed">
              <p>
                ...
                لوقت الخروج والعناية اليومية دون ادِّعاء «علاج» كوني.
              </p>
              <p>
              ...
              <p>
                كل منتج اليوم ضمن خط وجه خارجي مهيَّأ بتعليم صباحي أو مسائي حسب
                الصنف، مع فريق دعم يفسِّر الأسئلة الشائعة عن الحساسية والتوصيل.
              </p>
            </div>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-warm-sand text-xl font-bold mb-4">
              «نعطي البنات خط وجه واضح للثبات والنهار وخط الجبهة — بدون مبالغة.»
            </p>
